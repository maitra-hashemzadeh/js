...
// console.log(numOne >= numTwo, numTwo >= numThree); //false
console.log(numOne <= numTwo, numTwo >= numThree); //true answer
...
const numberTwo = 4;
const numberThree = 2;
// console.log(numberOne <= numberTwo, numberTwo <= numberThree); //false
console.log(numberOne <= numberTwo, numberTwo >= numberThree); //true answer